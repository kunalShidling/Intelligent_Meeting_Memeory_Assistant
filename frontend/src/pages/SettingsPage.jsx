  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="mt-1 text-gray-600">Configure your Meeting Assistant</p>
      </div>

      {saved && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <p className="text-green-800">Settings saved successfully! Redirecting to Dashboard...</p>
        </div>
      )}
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Camera Settings</h2>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center space-x-2 mb-4">
          <Camera className="w-5 h-5 text-gray-600" />
          <h2 className="text-xl font-semibold text-gray-900">Face Recognition Settings</h2>
        </div>
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
